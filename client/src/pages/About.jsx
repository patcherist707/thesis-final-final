   ...
   <section className="container mx-auto md:pl-56 mt-40 mb-40"> 
    <div className="flex flex-col md:flex-row items-center gap-10 p-4 md:p-0">
          <div className="mb-4 md:mb-0 border border-dashed border-[#4f3e2d] p-2">
            ...
            <div className="md:w-1/2 md:ml-4 text-justify">
              ...
              <p className="mb-4 leading-8">Rice Monitoring is an essential system in reaching standardized production levels for good supply chain and a requirement needed for highly efficient and effective warehouse management. The website dashboard enables the user to monitor the data provided by the installed sensors and specific components.</p>
    ...
    <div className="flex flex-col md:flex-row items-center gap-10 p-4 md:p-0 mt-24">
          <div className="md:w-1/2 md:ml-4 text-justify">
            ...
            <p className="mb-4 leading-8">We are the researchers of this thesis entitled An IoT-Based Approach to Rice Storage Monitoring System: Implementing RFID and DHT22 Sensors for Quality Preservation. We are composed of two students namely: Ruhayna Adje and Patricia Madeth Buna. We, the researchers, are currently studying from Bachelor of Science in Computer Engineering program of the College of Engineering Education at University of Mindanao. </p>
